...
function getToolMeta(mode) {
  if (mode === "chat") return { title: "New Chat", welcome: "Let's chat about anything!" };
  if (mode === "group") return { title: "Group Chat", welcome: "Welcome to group chat!" };
  if (mode === "level") return { title: "Level Test", welcome: "Let’s determine your English level." };
  if (mode === "interview") return { title: "Interview", welcome: "Tell me about yourself. (Start with your experience!)" };
  if (mode === "translate") return { title: "Translate", welcome: "Paste text and tell me the target language." };
